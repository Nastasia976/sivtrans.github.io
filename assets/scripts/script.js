...
$('.installation').click(function (event) {
    ...
    $('.items-about-monitoring, .items-about-integration, .items-about-service').removeClass('active');
});

$('.monitoring').click(function (event) {
    $('.items-about-monitoring').addClass('active');

    $('.items-about-installation, .items-about-integration, .items-about-service').removeClass('active');
});
...
$('.integration').click(function (event) {
    ...
    $('.items-about-installation, .items-about-monitoring, .items-about-service').removeClass('active');
...
$('.service').click(function (event) {
    ...
    $('.items-about-installation, .items-about-monitoring, .items-about-integration').removeClass('active');
