$(document).ready(function () {
    ...
    $('.catalog__column-left__bottom').slick({
        arrows: true,
        slidesToShow: 4,
        slidesToScroll: 1,
        draggable: false,
    ...
    $('.burger').click(function (event) {
        $('.catalog-menu, .transp-menu, .torg-menu, .menu-choice').removeClass('active');
    });
...
//_____________PageRefrigerationEquipment_______

$('.installation').click(function (event) {
    $('.items-about-installation').addClass('active');
    $('.installation').addClass('active');

    $('.items-about-monitoring, .monitoring, .items-about-integration, .integration, .items-about-service, .service').removeClass('active');
});

$('.monitoring').click(function (event) {
    $('.items-about-monitoring').addClass('active');
    $('.monitoring').addClass('active');

    $('.items-about-installation, .installation, .items-about-integration, .integration, .items-about-service, .service').removeClass('active');
    $('.items-about-installation, .items-about-integration, .items-about-service').addClass('passive');
});


$('.integration').click(function (event) {
    $('.items-about-integration').addClass('active');
    $('.integration').addClass('active');

    $('.items-about-installation, .installation, .items-about-monitoring, .monitoring, .items-about-service, .service').removeClass('active');
    $('.items-about-installation, .items-about-monitoring, .items-about-service').addClass('passive');
});

$('.service').click(function (event) {
    $('.items-about-service').addClass('active');
    $('.service').addClass('active');

    $('.items-about-installation, .installation, .items-about-monitoring, .monitoring, .items-about-integration, .integration').removeClass('active');
    $('.items-about-installation, .items-about-monitoring, .items-about-integration').addClass('passive');
});